    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-6 grid lg:grid-cols-12 gap-10 items-center w-full">
        <div className="lg:col-span-7 fade-up">
          ...
          <h1 className="font-sans text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.05]">
            Gaurav <span className="text-neon text-glow">Mittal</span>.
          </h1>
          <p className="mt-3 text-2xl sm:text-3xl text-muted-foreground font-medium">
          ...
          <div className="mt-10 flex flex-wrap items-center gap-3">
            <a
              href="#projects"
              className="group relative inline-flex items-center gap-2 px-6 py-3 rounded-md bg-neon text-primary-foreground font-mono text-sm font-semibold shadow-[0_4px_14px_0_var(--color-neon-soft)] hover:shadow-[0_6px_20px_0_var(--color-neon-soft)] hover:-translate-y-0.5 transition-all"
            >
              view_projects()
            </a>
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-md border border-border bg-card/50 backdrop-blur font-mono text-sm hover:border-neon hover:text-neon transition-colors"
            >
            ...
            <div className="ml-2 flex items-center gap-2">
              <a
                ...
                rel="noreferrer"
                aria-label="GitHub"
                className="h-10 w-10 grid place-items-center rounded-md border border-border hover:border-neon hover:text-neon transition-colors"
              >
